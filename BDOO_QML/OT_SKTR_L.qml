...
<qgis version="3.22.15-Białowieża" simplifyDrawingHints="1" symbologyReferenceScale="-1" minScale="100000000" simplifyLocal="1" maxScale="0" labelsEnabled="0" hasScaleBasedVisibilityFlag="0" styleCategories="Symbology|Symbology3D|Labeling|Fields|Forms|Actions|MapTips|Diagrams|AttributeTable|Rendering|CustomProperties|GeometryOptions|Relations|Temporal|Legend|Elevation|Notes" simplifyMaxScale="1" simplifyAlgorithm="0" simplifyDrawingTol="1">
  ...
  <defaults>
    ...
    <default expression="" field="liczbaTorow" applyOnUpdate="0"/>
    <default expression="" field="polozenie" applyOnUpdate="0"/>
    <default expression="" field="rodzajPojazduSzynowego" applyOnUpdate="0"/>
    <default expression="" field="rodzajTorow" applyOnUpdate="0"/>
    <default expression="" field="rodzajTrakcji" applyOnUpdate="0"/>
    <default expression="" field="numerLinii" applyOnUpdate="0"/>
...
def my_form_open(dialog, layer, feature):
  ...
  <editable>
    <field name="PL.PZGiK.201.32__OT_LINIAKOLEJOWA OT_LiniaKolejowa_nrLinii" editable="0"/>
    <field name="czyObiektBDOO" editable="1"/>
    <field name="funkcjaToru" editable="1"/>
    <field name="gml_id" editable="1"/>
    <field name="kategoriaIstnienia" editable="1"/>
    <field name="kodKarto250k" editable="1"/>
    <field name="liczbaTorow" editable="1"/>
    <field name="liniaKolejowa" editable="1"/>
    <field name="liniakolejowa_gmlid" editable="0"/>
    <field name="lokalnyId" editable="1"/>
    <field name="numerLinii" editable="1"/>
    ...
    <field name="rodzajPojazduSzynowego" editable="1"/>
    <field name="rodzajTorow" editable="1"/>
    <field name="rodzajTrakcji" editable="1"/>
