...
<qgis version="3.22.15-Białowieża" simplifyDrawingHints="1" symbologyReferenceScale="-1" minScale="100000000" simplifyLocal="1" maxScale="0" labelsEnabled="0" hasScaleBasedVisibilityFlag="0" styleCategories="Symbology|Symbology3D|Labeling|Fields|Forms|Actions|MapTips|Diagrams|AttributeTable|Rendering|CustomProperties|GeometryOptions|Relations|Temporal|Legend|Elevation|Notes" simplifyMaxScale="1" simplifyAlgorithm="0" simplifyDrawingTol="1">
  ...
  <renderer-v2 symbollevels="0" enableorderby="0" referencescale="-1" forceraster="0" attr="kodKarto250k" type="categorizedSymbol">
    <categories>
      <category label="granica parku krajobrazowego" render="true" symbol="0" value="0250_509"/>
    </categories>
    <symbols>
      <symbol alpha="1" force_rhr="0" name="0" type="fill" clip_to_extent="1">
        ...
        <layer class="SimpleLine" enabled="1" pass="0" locked="0">
          <Option type="Map">
            ...
            <Option name="line_color" type="QString" value="62,160,67,255"/>
        ...
        <layer class="MarkerLine" enabled="1" pass="0" locked="0">
          <Option type="Map">
            ...
            <Option name="interval" type="QString" value="700"/>
          ...
          <symbol alpha="1" force_rhr="0" name="@0@1" type="marker" clip_to_extent="1">
            ...
            <layer class="SimpleMarker" enabled="1" pass="0" locked="0">
              <Option type="Map">
                ...
                <Option name="color" type="QString" value="62,160,67,255"/>
                <Option name="horizontal_anchor_point" type="QString" value="1"/>
                <Option name="joinstyle" type="QString" value="bevel"/>
                <Option name="name" type="QString" value="half_square"/>
                <Option name="offset" type="QString" value="0,80"/>
                <Option name="offset_map_unit_scale" type="QString" value="3x:0,0,0,0,0,0"/>
                <Option name="offset_unit" type="QString" value="MapUnit"/>
                ...
                <Option name="size" type="QString" value="150"/>
  ...
  <labeling type="simple">
    <settings calloutType="simple">
      <text-style fontWeight="50" fontWordSpacing="0" allowHtml="0" fontFamily="Arial" textOpacity="1" textOrientation="horizontal" fontItalic="0" fontKerning="1" previewBkgrdColor="255,255,255,255" legendString="Aa" fontSizeUnit="MapUnit" capitalization="0" fontSizeMapUnitScale="3x:0,0,0,0,0,0" useSubstitutions="0" fontLetterSpacing="0" textColor="62,160,67,255" fieldName="upper (nazwa)" fontStrikeout="0" isExpression="1" fontSize="500" fontUnderline="0" blendMode="0" namedStyle="Normal" multilineHeight="1">
        <families/>
        <text-buffer bufferDraw="1" bufferColor="255,255,255,255" bufferBlendMode="0" bufferSizeUnits="MM" bufferNoFill="1" bufferSizeMapUnitScale="3x:0,0,0,0,0,0" bufferJoinStyle="128" bufferSize="0.59999999999999998" bufferOpacity="1"/>
      ...
      <text-format useMaxLineLengthForAutoWrap="1" plussign="0" formatNumbers="0" addDirectionSymbol="0" multilineAlign="1" leftDirectionSymbol="&lt;" rightDirectionSymbol=">" autoWrapLength="0" reverseDirectionSymbol="0" wrapChar=" " placeDirectionSymbol="0" decimals="3"/>
      <placement polygonPlacementFlags="2" offsetUnits="MM" overrunDistanceMapUnitScale="3x:0,0,0,0,0,0" placement="4" overrunDistance="0" labelOffsetMapUnitScale="3x:0,0,0,0,0,0" preserveRotation="1" offsetType="0" predefinedPositionOrder="TR,TL,BR,BL,R,L,TSR,BSR" rotationUnit="AngleDegrees" overrunDistanceUnit="MM" layerType="UnknownGeometry" dist="50" centroidWhole="0" rotationAngle="0" geometryGeneratorType="PointGeometry" xOffset="0" yOffset="0" repeatDistanceUnits="MM" lineAnchorType="0" geometryGenerator="" geometryGeneratorEnabled="0" distUnits="MM" priority="5" fitInPolygonOnly="1" maxCurvedCharAngleIn="25" quadOffset="4" maxCurvedCharAngleOut="-25" lineAnchorClipping="0" repeatDistanceMapUnitScale="3x:0,0,0,0,0,0" distMapUnitScale="3x:0,0,0,0,0,0" placementFlags="10" centroidInside="1" repeatDistance="0" lineAnchorPercent="0.5"/>
  ...
  <aliases>
    ...
    <alias field="numerCRFOP" name="" index="8"/>
    <alias field="nazwa" name="" index="9"/>
  </aliases>
  <defaults>
    ...
    <default expression="" field="numerCRFOP" applyOnUpdate="0"/>
  ...
  <constraints>
    ...
    <constraint field="numerCRFOP" unique_strength="0" notnull_strength="0" constraints="0" exp_strength="0"/>
  ...
  <constraintExpressions>
    ...
    <constraint field="numerCRFOP" exp="" desc=""/>
  ...
  <attributetableconfig actionWidgetStyle="dropDown" sortExpression="" sortOrder="0">
    <columns>
      ...
      <column hidden="0" name="numerCRFOP" width="-1" type="field"/>
...
def my_form_open(dialog, layer, feature):
  ...
  <editable>
    ...
    <field name="numerCRFOP" editable="1"/>
  ...
  <labelOnTop>
    ...
    <field labelOnTop="0" name="numerCRFOP"/>
  ...
  <reuseLastValue>
    ...
    <field reuseLastValue="0" name="numerCRFOP"/>
