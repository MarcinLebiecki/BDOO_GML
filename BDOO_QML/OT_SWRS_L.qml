...
<qgis version="3.22.15-Białowieża" simplifyDrawingHints="1" symbologyReferenceScale="-1" minScale="100000000" simplifyLocal="1" maxScale="0" labelsEnabled="0" hasScaleBasedVisibilityFlag="0" styleCategories="Symbology|Symbology3D|Labeling|Fields|Forms|Actions|MapTips|Diagrams|AttributeTable|Rendering|CustomProperties|GeometryOptions|Relations|Temporal|Legend|Elevation|Notes" simplifyMaxScale="1" simplifyAlgorithm="0" simplifyDrawingTol="1">
  ...
  <renderer-v2 symbollevels="0" enableorderby="0" referencescale="-1" forceraster="0" attr="kodKarto250k" type="categorizedSymbol">
    <categories>
      <category label="rzeka zeglowna symbol" render="true" symbol="0" value="0250_607_2"/>
      <category label="rzeka niezeglowna symbol" render="true" symbol="1" value="0250_608_2"/>
      <category label="inne" render="true" symbol="2" value=""/>
    </categories>
    <symbols>
      <symbol alpha="1" force_rhr="0" name="0" type="line" clip_to_extent="1">
        ...
        <layer class="SimpleLine" enabled="1" pass="0" locked="0">
          <Option type="Map">
            ...
            <Option name="line_color" type="QString" value="27,90,132,255"/>
      ...
      <symbol alpha="1" force_rhr="0" name="1" type="line" clip_to_extent="1">
        ...
        <layer class="SimpleLine" enabled="1" pass="0" locked="0">
          <Option type="Map">
            ...
            <Option name="draw_inside_polygon" type="QString" value="0"/>
            <Option name="joinstyle" type="QString" value="bevel"/>
            <Option name="line_color" type="QString" value="83,174,221,255"/>
            <Option name="line_style" type="QString" value="solid"/>
            <Option name="line_width" type="QString" value="78"/>
            <Option name="line_width_unit" type="QString" value="MapUnit"/>
            <Option name="offset" type="QString" value="0"/>
  ...
  <labeling type="rule-based">
    <rules key="{d8141537-2cff-4aba-aa79-daa2e531d0b5}">
      <rule description="Rzeka zeglowna" key="{2ecf2514-e6c3-43d5-bd49-0e30061d7492}" filter=" &quot;x_kodKarto250k&quot;  = '0250_607_2'">
      ...
      <rule description="Rzeka nie zeglowna" key="{2e66a863-39e6-492f-b13c-353bc2ea19a1}" filter=" &quot;x_kodKarto250k&quot;  = '0250_608_2' and  &quot;x_rodzajReprGeom&quot;  = 'OG'">
        <settings calloutType="simple">
          <text-style fontWeight="50" fontWordSpacing="0" allowHtml="0" fontFamily="Cambria" textOpacity="1" textOrientation="horizontal" fontItalic="1" fontKerning="1" previewBkgrdColor="255,255,255,255" legendString="Aa" fontSizeUnit="MapUnit" capitalization="0" fontSizeMapUnitScale="3x:0,0,0,0,0,0" useSubstitutions="0" fontLetterSpacing="0" textColor="17,150,206,255" fieldName="PL.PZGiK.201.32__OT_CIEK OT_Ciek_nazwa" fontStrikeout="0" isExpression="0" fontSize="500" fontUnderline="0" blendMode="0" namedStyle="Italic" multilineHeight="1">
            <families/>
            <text-buffer bufferDraw="1" bufferColor="255,255,255,255" bufferBlendMode="0" bufferSizeUnits="MM" bufferNoFill="1" bufferSizeMapUnitScale="3x:0,0,0,0,0,0" bufferJoinStyle="128" bufferSize="0.69999999999999996" bufferOpacity="1"/>
  ...
  <fieldConfiguration>
    ...
    <field configurationFlags="None" name="ciek1_gmlid">
      <editWidget type="TextEdit">
        <config>
          <Option/>
        </config>
  ...
  <aliases>
    ...
    <alias field="uwagi" name="" index="7"/>
    <alias field="kodKarto250k" name="" index="8"/>
    <alias field="identyfikatorPRNG" name="" index="9"/>
    <alias field="polozenie" name="" index="10"/>
    <alias field="szerokosc" name="" index="11"/>
    <alias field="szerokosc_uom" name="" index="12"/>
    <alias field="nazwa" name="" index="13"/>
    <alias field="rodzaj" name="" index="14"/>
    <alias field="statusEksploatacji" name="" index="15"/>
    <alias field="przebieg" name="" index="16"/>
    <alias field="cechaGeometrii" name="" index="17"/>
    <alias field="identyfikatorMPHP" name="" index="18"/>
    <alias field="informacjaDodatkowa" name="" index="19"/>
    <alias field="ciek1_gmlid" name="" index="20"/>
  </aliases>
  <defaults>
    ...
    <default expression="" field="uwagi" applyOnUpdate="0"/>
    ...
    <default expression="" field="ciek1_gmlid" applyOnUpdate="0"/>
  </defaults>
  <constraints>
    ...
    <constraint field="uwagi" unique_strength="0" notnull_strength="0" constraints="0" exp_strength="0"/>
    ...
    <constraint field="statusEksploatacji" unique_strength="0" notnull_strength="0" constraints="0" exp_strength="0"/>
    <constraint field="przebieg" unique_strength="0" notnull_strength="0" constraints="0" exp_strength="0"/>
    <constraint field="cechaGeometrii" unique_strength="0" notnull_strength="0" constraints="0" exp_strength="0"/>
    ...
    <constraint field="ciek1_gmlid" unique_strength="0" notnull_strength="0" constraints="0" exp_strength="0"/>
  </constraints>
  <constraintExpressions>
    ...
    <constraint field="uwagi" exp="" desc=""/>
    ...
    <constraint field="ciek1_gmlid" exp="" desc=""/>
  </constraintExpressions>
  <expressionfields>
    <field expression="regexp_substr( ciek1,'#(.*)')" length="250" precision="0" subType="0" typeName="string" name="ciek1_gmlid" comment="" type="10"/>
  </expressionfields>
  <attributeactions>
  ...
  <attributetableconfig actionWidgetStyle="dropDown" sortExpression="" sortOrder="0">
    <columns>
      ...
      <column hidden="0" name="szerokosc" width="-1" type="field"/>
      <column hidden="0" name="szerokosc_uom" width="-1" type="field"/>
      <column hidden="0" name="przebieg" width="-1" type="field"/>
      <column hidden="0" name="rodzaj" width="-1" type="field"/>
      <column hidden="0" name="statusEksploatacji" width="-1" type="field"/>
...
def my_form_open(dialog, layer, feature):
  ...
  <reuseLastValue>
    ...
    <field reuseLastValue="0" name="ciek1_gmlid"/>
