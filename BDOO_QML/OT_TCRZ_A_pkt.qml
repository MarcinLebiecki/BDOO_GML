...
<qgis maxScale="0" labelsEnabled="0" simplifyAlgorithm="0" simplifyMaxScale="1" hasScaleBasedVisibilityFlag="0" version="3.4.0-Madeira" simplifyDrawingHints="1" styleCategories="AllStyleCategories" simplifyLocal="1" readOnly="0" minScale="1e+08" simplifyDrawingTol="1">
  ...
  <renderer-v2 attr="x_kodKarto250k" symbollevels="0" type="categorizedSymbol" forceraster="0" enableorderby="0">
    <categories>
      <category render="true" value="0250_508_2" label="rezerwat przyrody symbol" symbol="0"/>
    </categories>
    <symbols>
      <symbol type="fill" clip_to_extent="1" name="0" alpha="1">
        <layer locked="0" enabled="1" class="CentroidFill" pass="0">
          ...
          <symbol type="marker" clip_to_extent="1" name="@0@0" alpha="1">
            <layer locked="0" enabled="1" class="SvgMarker" pass="0">
              <prop k="angle" v="0"/>
              <prop k="color" v="255,0,0,255"/>
              <prop k="fixedAspectRatio" v="0"/>
              <prop k="horizontal_anchor_point" v="1"/>
              <prop k="name" v="KARTO250k/0250_508_2.svg"/>
              <prop k="offset" v="0,0"/>
  ...
  <aliases>
    ...
    <alias index="24" field="nazwa" name=""/>
    <alias index="25" field="x_doklGeom" name=""/>
    <alias index="26" field="x_doklGeom_uom" name=""/>
    <alias index="27" field="x_informDodatkowa" name=""/>
    <alias index="28" field="x_uwagi" name=""/>
  </aliases>
  ...
  <constraints>
    ...
    <constraint unique_strength="0" constraints="0" exp_strength="0" field="x_doklGeom" notnull_strength="0"/>
    <constraint unique_strength="0" constraints="0" exp_strength="0" field="x_doklGeom_uom" notnull_strength="0"/>
  ...
  <attributetableconfig actionWidgetStyle="dropDown" sortExpression="" sortOrder="0">
    <columns>
      ...
      <column width="-1" hidden="0" type="field" name="x_doklGeom"/>
      <column width="-1" hidden="0" type="field" name="x_doklGeom_uom"/>
