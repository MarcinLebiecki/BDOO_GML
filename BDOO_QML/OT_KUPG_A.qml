...
<qgis maxScale="0" labelsEnabled="0" simplifyAlgorithm="0" simplifyMaxScale="1" hasScaleBasedVisibilityFlag="0" version="3.4.0-Madeira" simplifyDrawingHints="1" styleCategories="AllStyleCategories" simplifyLocal="1" readOnly="0" minScale="1e+08" simplifyDrawingTol="1">
  ...
  <renderer-v2 attr="x_kod" symbollevels="0" type="categorizedSymbol" forceraster="0" enableorderby="0">
    <categories>
      <category render="true" value="KUPG01" label="elektrocieplownia" symbol="0"/>
      <category render="true" value="KUPG02" label="elektrownia" symbol="1"/>
      <category render="true" value="KUPG05" label="huta" symbol="2"/>
      <category render="true" value="KUPG06" label="kopalnia" symbol="3"/>
      <category render="true" value="KUPG08" label="podstacja elektroenergetyczna" symbol="4"/>
      <category render="true" value="KUPG10" label="rafineria" symbol="5"/>
      <category render="true" value="KUPG13" label="zaklad metalurgiczny" symbol="6"/>
    </categories>
    <symbols>
      <symbol type="fill" clip_to_extent="1" name="0" alpha="1">
        <layer locked="0" enabled="1" class="SimpleFill" pass="0">
          <prop k="border_width_map_unit_scale" v="3x:0,0,0,0,0,0"/>
          <prop k="color" v="235,231,106,255"/>
          <prop k="joinstyle" v="bevel"/>
          <prop k="offset" v="0,0"/>
          <prop k="offset_map_unit_scale" v="3x:0,0,0,0,0,0"/>
          <prop k="offset_unit" v="MapUnit"/>
          <prop k="outline_color" v="235,231,106,255"/>
      ...
      <symbol type="fill" clip_to_extent="1" name="1" alpha="1">
        <layer locked="0" enabled="1" class="SimpleFill" pass="0">
          <prop k="border_width_map_unit_scale" v="3x:0,0,0,0,0,0"/>
          <prop k="color" v="96,219,213,255"/>
          <prop k="joinstyle" v="bevel"/>
          <prop k="offset" v="0,0"/>
          <prop k="offset_map_unit_scale" v="3x:0,0,0,0,0,0"/>
          <prop k="offset_unit" v="MapUnit"/>
          <prop k="outline_color" v="96,219,213,255"/>
          <prop k="outline_style" v="solid"/>
          <prop k="outline_width" v="26"/>
          <prop k="outline_width_unit" v="MapUnit"/>
          <prop k="style" v="dense6"/>
      ...
      <symbol type="fill" clip_to_extent="1" name="2" alpha="1">
        <layer locked="0" enabled="1" class="SimpleFill" pass="0">
          ...
          <prop k="offset_map_unit_scale" v="3x:0,0,0,0,0,0"/>
          <prop k="offset_unit" v="MapUnit"/>
          <prop k="outline_color" v="183,72,75,255"/>
          <prop k="outline_style" v="solid"/>
          <prop k="outline_width" v="26"/>
          <prop k="outline_width_unit" v="MapUnit"/>
          <prop k="style" v="dense6"/>
      ...
      <symbol type="fill" clip_to_extent="1" name="4" alpha="1">
        <layer locked="0" enabled="1" class="SimpleFill" pass="0">
          ...
          <prop k="offset_map_unit_scale" v="3x:0,0,0,0,0,0"/>
          <prop k="offset_unit" v="MapUnit"/>
          <prop k="outline_color" v="231,113,72,255"/>
          <prop k="outline_style" v="solid"/>
          <prop k="outline_width" v="26"/>
          <prop k="outline_width_unit" v="MapUnit"/>
          <prop k="style" v="dense6"/>
      ...
      <symbol type="fill" clip_to_extent="1" name="5" alpha="1">
        <layer locked="0" enabled="1" class="SimpleFill" pass="0">
          ...
          <prop k="offset_map_unit_scale" v="3x:0,0,0,0,0,0"/>
          <prop k="offset_unit" v="MapUnit"/>
          <prop k="outline_color" v="152,125,183,255"/>
          <prop k="outline_style" v="solid"/>
          <prop k="outline_width" v="26"/>
          <prop k="outline_width_unit" v="MapUnit"/>
          <prop k="style" v="dense6"/>
      ...
      <symbol type="fill" clip_to_extent="1" name="6" alpha="1">
        <layer locked="0" enabled="1" class="SimpleFill" pass="0">
          ...
          <prop k="offset_map_unit_scale" v="3x:0,0,0,0,0,0"/>
          <prop k="offset_unit" v="MapUnit"/>
          <prop k="outline_color" v="190,207,80,255"/>
          <prop k="outline_style" v="solid"/>
          <prop k="outline_width" v="26"/>
          <prop k="outline_width_unit" v="MapUnit"/>
          <prop k="style" v="dense6"/>
  ...
  <DiagramLayerSettings priority="0" obstacle="0" showAll="1" linePlacementFlags="18" dist="0" zIndex="0" placement="1">
    <properties>
      <Option type="Map">
        <Option value="" type="QString" name="name"/>
        <Option name="properties"/>
  ...
  <aliases>
    ...
    <alias index="23" field="rodzaj" name=""/>
    <alias index="24" field="x_informDodatkowa" name=""/>
    <alias index="25" field="nazwa" name=""/>
  </aliases>
  ...
  <constraints>
    ...
    <constraint unique_strength="0" constraints="0" exp_strength="0" field="nazwa" notnull_strength="0"/>
  </constraints>
  ...
  <attributetableconfig actionWidgetStyle="dropDown" sortExpression="" sortOrder="0">
    <columns>
      ...
      <column width="-1" hidden="0" type="field" name="nazwa"/>
