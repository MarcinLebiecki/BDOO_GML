...
<qgis version="3.22.15-Białowieża" simplifyDrawingHints="0" symbologyReferenceScale="-1" minScale="100000000" simplifyLocal="1" maxScale="0" labelsEnabled="1" hasScaleBasedVisibilityFlag="0" styleCategories="Symbology|Symbology3D|Labeling|Fields|Forms|Actions|MapTips|Diagrams|AttributeTable|Rendering|CustomProperties|GeometryOptions|Relations|Temporal|Legend|Elevation|Notes" simplifyMaxScale="1" simplifyAlgorithm="0" simplifyDrawingTol="1">
      ...
      <rule description="Miasto powyżej 1 000 000" key="{38717042-dbc4-4c2e-8fb0-34cd2c50b63a}" filter="&quot;liczbaMieszkancow&quot; > 1000000 and  &quot;rodzaj&quot; = 'miasto'">
        <settings calloutType="simple">
          <text-style fontWeight="75" fontWordSpacing="0" allowHtml="0" fontFamily="Arial" textOpacity="1" textOrientation="horizontal" fontItalic="0" fontKerning="1" previewBkgrdColor="255,255,255,255" legendString="Aa" fontSizeUnit="MapUnit" capitalization="0" fontSizeMapUnitScale="3x:0,0,0,0,0,0" useSubstitutions="0" fontLetterSpacing="0" textColor="0,0,0,255" fieldName=" upper( nazwa )" fontStrikeout="0" isExpression="1" fontSize="1800" fontUnderline="0" blendMode="0" namedStyle="Bold" multilineHeight="1">
            <families/>
            <text-buffer bufferDraw="1" bufferColor="255,255,255,255" bufferBlendMode="0" bufferSizeUnits="MM" bufferNoFill="1" bufferSizeMapUnitScale="3x:0,0,0,0,0,0" bufferJoinStyle="128" bufferSize="0.5" bufferOpacity="1"/>
  ...
  <fieldConfiguration>
    ...
    <field configurationFlags="None" name="identyfikatorTERC">
      <editWidget type="Range">
        <config>
          <Option/>
        </config>
    ...
    <field configurationFlags="None" name="liczbaMieszkancow">
      <editWidget type="Range">
        <config>
          <Option/>
        </config>
  ...
  <aliases>
    ...
    <alias field="identyfikatorSIMC" name="" index="9"/>
    <alias field="identyfikatorTERC" name="" index="10"/>
    <alias field="rodzaj" name="" index="11"/>
    <alias field="liczbaMieszkancow" name="" index="12"/>
    <alias field="identyfikatorPRNG" name="" index="13"/>
  ...
  <defaults>
    ...
    <default expression="" field="identyfikatorSIMC" applyOnUpdate="0"/>
    <default expression="" field="identyfikatorTERC" applyOnUpdate="0"/>
    <default expression="" field="rodzaj" applyOnUpdate="0"/>
    <default expression="" field="liczbaMieszkancow" applyOnUpdate="0"/>
  ...
  <constraints>
    ...
    <constraint field="identyfikatorSIMC" unique_strength="0" notnull_strength="0" constraints="0" exp_strength="0"/>
    <constraint field="identyfikatorTERC" unique_strength="0" notnull_strength="0" constraints="0" exp_strength="0"/>
  ...
  <constraintExpressions>
    ...
    <constraint field="identyfikatorTERC" exp="" desc=""/>
    <constraint field="rodzaj" exp="" desc=""/>
    <constraint field="liczbaMieszkancow" exp="" desc=""/>
  ...
  <attributetableconfig actionWidgetStyle="dropDown" sortExpression="" sortOrder="0">
    <columns>
      ...
      <column hidden="0" name="liczbaMieszkancow" width="-1" type="field"/>
      ...
      <column hidden="0" name="identyfikatorSIMC" width="-1" type="field"/>
      <column hidden="0" name="identyfikatorTERC" width="-1" type="field"/>
...
def my_form_open(dialog, layer, feature):
  ...
  <editable>
    ...
    <field name="identyfikatorTERC" editable="1"/>
